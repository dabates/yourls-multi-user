...
if ( ( verifyUrlOwner( $keyword, $user["id"] ) && YOURLS_MULTIUSER_PROTECTED === true ) || YOURLS_MULTIUSER_PROTECTED === false ) {
    ...
    <h3 id="longurl"><span class="label">Long URL:</span> <img class="fix_images"
                                                               src="<?php echo yourls_get_favicon_url( $longurl ); ?>"/> <?php yourls_html_link( $longurl, yourls_trim_long_string( $longurl ), 'longurl' ); ?>
    </h3>
                    ...
                    <table border="0" cellspacing="2">
                        <tr>
                                    ...
                                    if ( ${'do_' . $graph} == true ) {
                                        ...
                                        switch ( $graph ) {
                                            case '24':
                                                ...
                                                $labels_2    = [ $first_label, $last_label ];
                                                // Get hh of each key
                            ...
                            <td valign="top">
                                ...
                                ?>
                                <p>Short URL created
                                    on <?php echo date( "F j, Y @ g:i a", strtotime( $timestamp ) ); ?> <?php echo $daysago; ?></p>
                                <div class="wrap_unfloat">
                                ...
                                <p>
                                    <strong><?php echo $best['max']; ?></strong> <?php echo yourls_plural( 'hit', $best['max'] ); ?>
                                    on <?php echo date( "F j, Y", strtotime( $best['day'] ) ); ?>.
                                    <a href="" class='details hide-if-no-js' id="more_clicks">Click for more details</a>
                                </p>
                    ...
                    <table border="0" cellspacing="2">
                        <tr>
                            <td valign="top">
                                ...
                                <p><a href="" class='details hide-if-no-js' id="more_countries">Click for more
                                        details</a></p>
                    ...
                    <table border="0" cellspacing="2">
                        <tr>
                                ...
                                <ul class="no_bullet">
                                    ...
                                    foreach ( $referrer_sort as $site => $count ) {
                                        ...
                                        foreach ( $referrers[ $site ] as $url => $count ) {
                                            echo "<li>";
                                            yourls_html_link( $url );
                                            echo ": <strong>$count</strong></li>\n";
                                        }
                                        echo "</ul>\n";
                            ...
                            <td valign="top">
                                ...
                                <?php
                                yourls_stats_pie( [ 'Direct' => $direct, 'Referrers' => $notdirect ], 5, '440x220' );
                                ?>
                                <p>Direct traffic:
                                    <strong><?php echo $direct; ?></strong> <?php echo yourls_plural( 'hit', $direct ); ?>
                                </p>
                                <p>Referrer traffic:
                                    <strong><?php echo $notdirect; ?></strong> <?php echo yourls_plural( 'hit', $notdirect ); ?>
                                </p>
